...
export default function EmailCampaignDetail() {
	...
	const [emailCampaign_id, setemailCampaign_id] = useState("");
	const [delete_modal_show, setdelete_modal_show] = useState(false);

	useEffect(() => {
		setemailCampaign_id(location?.state?.id);
		get_emailCampaign_details(location?.state?.id);
	}, [location?.state?.id]);
								...
								<div className="row">
									<div className="col-12 mb-3">
										...
										<div className="form-detail-text">
											<span id="camp-name">{emailCampaign_details.campaignName}</span>
										</div>
									</div>
									<div className="col-12 mb-3">
										<div className="label-comn-text-1">Description</div>
										<div className="form-detail-text">
											<span id="description">{emailCampaign_details.description}</span>
										</div>
									</div>
									<div className="col-12 mb-3">
									...
									<div className="col-12 mb-3">
										...
										<div className="d-sm-flex align-items-center">
											{emailCampaign_details &&
												emailCampaign_details.product_variant.map((item, i) => {
													return (
														<>
															{item.color[0] !== "" && (
																<div className="d-flex me-3" key={i}>
											...
											{/* <div className="d-flex me-3">
                                                        ...
                                                        <div className="form-detail-text">
                                                            {emailCampaign_details && emailCampaign_details.product_variant.map((item) => {
                                                                return (
											...
											<div className="d-flex">
												...
												<div className="form-detail-text">
													{emailCampaign_details &&
														emailCampaign_details.product_variant.map((item, index) => {
															return (
																<>
																	{item.size &&
																		item.size.map((s, i) => {
									...
									{/* <div className="col-12 mb-3">
                                                ...
                                                <div className="form-detail-text">
                                                    <span id="description">{emailCampaign_details.productName}</span>
                                                </div>
                                            </div> */}
									<div className="col-12">
										...
										<div className="form-detail-text">
											<span id="Add-img">
												<div className="row">
													{emailCampaign_details.uploadImg &&
														emailCampaign_details.uploadImg.map((item, i) => {
															return (
																<>
																	{item !== "" && (
													...
													{emailCampaign_details.productImage &&
														emailCampaign_details.productImage.map((item, i) => {
															return (
																<div key={i} className="col-xxl-1 col-xl-2  col-md-3 col-sm-4 col-6 mb-3 ms-0">
																	<div className="add-img-class">
																		<img src={item} key={i} className="img-fluid position-relative" alt="add-pic" />
									...
									<div className="col-12 mb-3">
										...
										<div className="form-detail-text">
											<span id="customer-list">{emailCampaign_details.groupname}</span>
										</div>
									</div>
									<div className="col-md-8 mb-3">
										<div className="label-comn-text-1">Text Message</div>
										<div className="form-detail-text">
											<span id="message">{emailCampaign_details.textMsg}</span>
										</div>
									</div>
									{/* <div className="col-12">
                                                    ...
                                                    <span id="Add-img">
                                                        <div className="row">
                                                            <div className="col-xxl-1 col-xl-2  col-md-3 col-sm-4 col-6 mb-3 ms-0">
                                                                <div className="add-img-class">
                                                                    <img src={emailCampaign_details.uploadImg} className="img-fluid position-relative" alt="add-pic" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </span>
										...
										<div className="form-detail-text">
											<div className="scheduled-data">
												...
												<span className="form-detail-text me-4" id="sch-date">
													{moment(emailCampaign_details.date).format("DD, MMM YYYY")}
												</span>
									...
									<div className="col-12">
										<div className="row">
											<div className="col-xxl-2 col-md-3 col-6">
												<button type="button" className="btn-comn-class w-100" onClick={() => Navigate("/edit-email-campaign/", { state: { id: emailCampaign_id } })}>
													Edit
												</button>
											</div>
											<div className="col-xxl-2 col-md-3 col-6">
